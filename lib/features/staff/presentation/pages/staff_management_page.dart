...
class _StaffManagementPageState extends ConsumerState<StaffManagementPage>
  ...
  Widget _buildDirectoryTab(bool isDark, String activeBranchId) {
    ...
    final staffList = allStaff.where((s) {
      if (isOrgAdmin) {
        ...
        return s.branchId == _filterBranchId ||
            s.sharedBranchIds.contains(_filterBranchId);
      }
      return s.branchId == activeBranchId ||
          s.sharedBranchIds.contains(activeBranchId);
    }).toList();
          ...
          if (isOrgAdmin) ...[
            GlassCard(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    '🏢 Branch-wise Headcount & Analytics Comparison',
                  ...
                  Table(
                    ...
                    children: [
                      ...
                      ...branches.map((b) {
                        final bStaff = allStaff
                            .where((s) => s.branchId == b.id)
                            .toList();
                        final sharedStaff = allStaff
                            .where((s) => s.sharedBranchIds.contains(b.id))
                            .toList();
                        return TableRow(
                          children: [
                            Padding(
                            ...
                            Padding(
                              padding: const EdgeInsets.all(6),
                              child: Text(
                                '${bStaff.length + sharedStaff.length} (Primary: ${bStaff.length})',
                            ...
                            Padding(
                              padding: const EdgeInsets.all(6),
                              child: Text(
                                '${bStaff.where((s) => s.role == 'Teacher').length + sharedStaff.where((s) => s.role == 'Teacher').length}',
                                style: const TextStyle(fontSize: 9),
                              ),
                            ),
                            Padding(
                ...
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                        value: 'Teacher',
                        child: Text('Teacher', style: TextStyle(fontSize: 10)),
                      ),
                      DropdownMenuItem(
                        value: 'HOD',
                        child: Text('HOD', style: TextStyle(fontSize: 10)),
                      ),
                      DropdownMenuItem(
                        value: 'branchAdmin',
          ...
          Row(
            ...
            children: [
              ...
              if (_selectedStaff != null) ...[
                ...
                Expanded(
                  flex: 2,
                  child: _buildProfileSidebar(isDark, activeBranchId),
                ),
              ],
            ],
          ),
  ...
  void _showExportSnack(String format) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Staff directory exported as $format successfully!'),
      ),
    );
  }
  ...
  Widget _buildProfileSidebar(bool isDark, String activeBranchId) {
    final staff = ref
        ...
        .firstWhere(
          ...
          orElse: () => _selectedStaff!,
        );
    final branches = ref.watch(organizationBranchesProvider);
    final primaryBranchName = branches.any((b) => b.id == staff.branchId)
        ? branches.firstWhere((b) => b.id == staff.branchId).name
        : 'Main Campus';
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () =>
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Dialing ${staff.name} at ${staff.phone}...',
                                ),
                              ),
                            ),
                      ),
                      ...
                      IconButton(
                        ...
                        onPressed: () =>
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Opening compose mail to ${staff.email}...',
                                ),
                              ),
                            ),
                      ),
                      ...
                      IconButton(
                        ...
                        onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Simulating WhatsApp chat with ${staff.phone}...',
                            ),
                          ),
                        ),
                      ),
            ...
            _profileRow('Phone', staff.phone),
            _profileRow('Email', staff.email),
            _profileRow('Gender', staff.gender),
            _profileRow('DOB', staff.dateOfBirth),
            _profileRow('Blood Group', staff.bloodGroup),
            _profileRow('Address', staff.address),
            const SizedBox(height: 12),
            _sectionHeader('Professional Details'),
            _profileRow('Department', deptName),
            _profileRow('Qualification', staff.qualification),
            _profileRow('Specialization', staff.specialization),
            _profileRow('Institution', staff.institution),
            _profileRow('Experience', '${staff.yearsOfExperience} Years'),
            _profileRow('Previous Employer', staff.previousEmployer),
            _profileRow('Role Access', staff.role),
            const SizedBox(height: 12),
            ...
            if (staff.sharedBranchIds.isEmpty)
              ...
              ...staff.sharedBranchIds.map((bId) {
                final bName = branches.any((b) => b.id == bId)
                    ? branches.firstWhere((b) => b.id == bId).name
                    : bId;
                return Container(
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ref
                              ...
                              .removeSharedBranch(staff.id, bId);
                        },
                      ),
                    ],
                  ),
            ...
            DropdownButtonFormField<String>(
              ...
              items: branches
                  .where(
                    (b) =>
                        b.id != staff.branchId &&
                        !staff.sharedBranchIds.contains(b.id),
                  )
                  .map(
                    (b) => DropdownMenuItem(
                      value: b.id,
              ...
              onChanged: (v) {
                if (v != null) {
                  ref.read(staffProvider.notifier).addSharedBranch(staff.id, v);
                }
              },
            ),
            const SizedBox(height: 12),
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                onPressed: () => _showExperienceCertificateDialog(
                  context,
                  staff,
                  branches.firstWhere(
                    (b) => b.id == staff.branchId,
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                onPressed: () => _showRelievingLetterDialog(
                  context,
                  staff,
                  branches.firstWhere(
                    (b) => b.id == staff.branchId,
  ...
  Widget _buildDocumentsTab(bool isDark, String branchId) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Document Management Vault (Branch-Scoped)',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
          ),
          const Text(
            'Manage degrees, certificates, and identity proofs for all branch staff.',
          ...
          ...branchStaff.map(
            (staff) => GlassCard(
              ...
              child: ExpansionTile(
                ...
                subtitle: Text(
                  '${staff.employeeId} | ${staff.uploadedDocuments.length} documents uploaded',
                  style: const TextStyle(fontSize: 10, color: Colors.grey),
                ),
                children: [
                  const Divider(),
                  ...staff.uploadedDocuments.map(
                    (doc) => ListTile(
                      dense: true,
                      leading: const Icon(
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: docTypes
                          .where((d) => !staff.uploadedDocuments.contains(d))
                          .map(
                            (d) => DropdownMenuItem(
                              value: d,
                              child: Text(
                      ...
                      onChanged: (v) {
                        if (v != null) {
                          ref
                              .read(staffProvider.notifier)
                              .uploadDocument(staff.id, v);
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                '$v uploaded & encrypted for ${staff.name}!',
                              ),
                            ),
                          );
                        }
  ...
  Widget _buildSubjectTeacherTab(bool isDark, String branchId) {
    ...
    final branchStaff = ref
        ...
        .where(
          (s) =>
              (s.branchId == branchId ||
                      s.sharedBranchIds.contains(branchId)) &&
                  s.role == 'Teacher' ||
              s.role == 'HOD',
        )
        .toList();
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Class Teacher Allocation (Per Section)',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
          ),
          const Text(
            'Assign class teachers to each section within branch.',
            style: TextStyle(fontSize: 11, color: Colors.grey),
          ),
          const SizedBox(height: 12),
          ...classes.map((cls) {
          ...
          // Subject Assignments
          const Text(
            'Subject-Teacher Assignments (Per Branch)',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
          ),
          const Text(
            'Map subjects to teachers for each class and section.',
            style: TextStyle(fontSize: 11, color: Colors.grey),
          ),
          const SizedBox(height: 12),
          if (assignments.isEmpty)
            ...
            ...assignments.map((a) {
              final clsName = classes.any((c) => c.id == a.classId)
                  ? classes.firstWhere((c) => c.id == a.classId).name
                  : a.classId;
              final secName = sections.any((s) => s.id == a.sectionId)
                  ? sections.firstWhere((s) => s.id == a.sectionId).name
                  : a.sectionId;
              return ListTile(
                dense: true,
                leading: const Icon(
                ...
                subtitle: Text(
                  '$clsName | Section $secName | Teacher: ${a.assignedTeacher}',
                  style: const TextStyle(fontSize: 9, color: Colors.grey),
                ),
                trailing: IconButton(
                  icon: const Icon(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Manage teacher substitutions within branch. Auto-suggests available staff.',
            style: TextStyle(fontSize: 11, color: Colors.grey),
          ),
          const SizedBox(height: 16),
          ...
          GlassCard(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Active Substitutions (${subs.where((s) => s.status == 'Active').length})',
                  style: const TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                if (subs.isEmpty)
                  const Center(
                    child: Padding(
                      padding: EdgeInsets.all(20),
                      child: Text('No substitution records.'),
                    ),
                  ),
                ...subs.map((sub) {
                  final origName = _staffName(sub.originalTeacherId);
                  final subName = _staffName(sub.substituteTeacherId);
                  final clsName = classes.any((c) => c.id == sub.classId)
                      ? classes.firstWhere((c) => c.id == sub.classId).name
                      : sub.classId;
  ...
  Widget _buildLeaveAttendanceTab(bool isDark, String branchId) {
    final leaves = ref
        .watch(staffLeaveProvider)
        .where((l) => l.branchId == branchId)
        .toList();
    final attendance = ref
        .watch(staffAttendanceProvider)
        .where((a) => a.branchId == branchId)
        .toList();
    final duties = ref
        .watch(dutyRosterProvider)
        .where((d) => d.branchId == branchId)
        .toList();
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () =>
                          _showMarkAttendanceDialog(context, branchId),
                    ),
                  ],
                ),
                const Divider(),
                ...attendance.map(
                  (a) => ListTile(
                    ...
                    subtitle: Text(
                      'Check-in: ${a.checkInTime} | Check-out: ${a.checkOutTime}',
                      style: const TextStyle(fontSize: 9, color: Colors.grey),
                    ),
                    trailing: Container(
                      padding: const EdgeInsets.symmetric(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text(
                      'Leave Applications (CL, EL, ML, Casual, Medical)',
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                      ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text(
                      "Today's Duty Roster & Shift Schedule",
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                      ),
  ...
  Widget _buildPayrollTab(bool isDark, String branchId) {
    final payrolls = ref
        .watch(staffPayrollProvider)
        .where((p) => p.branchId == branchId)
        .toList();
    final trainings = ref
        .watch(staffTrainingProvider)
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text(
                      'Payroll Processing (Branch-Scoped)',
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                      ),
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          onPressed: () =>
                              _showProcessPayrollDialog(context, branchId),
                        ),
                        IconButton(
                          icon: const Icon(
                          ...
                          onPressed: () =>
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Salary slips generated with branch header for all staff!',
                                  ),
                                ),
                              ),
                        ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () =>
                          _showScheduleTrainingDialog(context, branchId),
                    ),
                  ],
                ),
                const Divider(),
                ...trainings.map(
                  (t) => ListTile(
                    ...
                    subtitle: Text(
                      '${t.date} | Trainer: ${t.trainer} | Participants: ${t.participantStaffIds.length}',
                      style: const TextStyle(fontSize: 9, color: Colors.grey),
                    ),
                    trailing: Container(
                      padding: const EdgeInsets.symmetric(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text(
                      'Inter-Branch Staff Transfer Requests',
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                      ),
                    ...
                    IconButton(
                      ...
                      onPressed: () =>
                          _showRequestTransferDialog(context, branchId),
                    ),
                  ],
                ),
                const Divider(),
                if (transfers.isEmpty)
                  ...
                  ...transfers.map(
                    (t) => ListTile(
                      ...
                      subtitle: Text(
                        'From: ${t.fromBranchId} → To: ${t.toBranchId} | ${t.reason}',
                        style: const TextStyle(fontSize: 9, color: Colors.grey),
                      ),
                          ...
                          ? Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () => ref
                                      .read(staffTransferProvider.notifier)
  ...
  Widget _buildPerformanceTab(bool isDark, String branchId) {
    final reviews = ref
        .watch(performanceReviewProvider)
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Staff Performance Evaluation (Branch-Scoped)',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
          ),
          const Text(
            'Annual appraisal scores, teaching quality metrics, and review remarks.',
            style: TextStyle(fontSize: 11, color: Colors.grey),
          ),
          const SizedBox(height: 16),
          ...
          Builder(
            builder: (context) {
              final currentMonth = DateTime.now().month.toString().padLeft(
                2,
                '0',
              );
              final upcomingEvents = branchStaff.where((s) {
                final dobMonth = s.dateOfBirth.contains('-')
                    ? s.dateOfBirth.split('-')[1]
                    : '';
                final dojMonth = s.dateOfJoining.contains('-')
                    ? s.dateOfJoining.split('-')[1]
                    : '';
                  ...
                  children: [
                    ...
                    if (upcomingEvents.isEmpty)
                      ...
                      ...upcomingEvents.map((s) {
                        final isBirthday =
                            s.dateOfBirth.split('-')[1] == currentMonth;
                        final isAnniversary =
                            s.dateOfJoining.split('-')[1] == currentMonth;
                        String subtitle = '';
                        if (isBirthday && isAnniversary) {
                          subtitle =
                              'Birthday: ${s.dateOfBirth} & Work Anniversary (Joined: ${s.dateOfJoining})';
                        } else if (isBirthday) {
                          subtitle = 'Birthday: ${s.dateOfBirth}';
                        } else {
                          subtitle =
                              'Work Anniversary (Joined: ${s.dateOfJoining})';
                        }
                        return ListTile(
                          dense: true,
                          leading: Icon(
  ...
  Widget _buildOffboardingTab(bool isDark, String branchId) {
    final branchStaff = ref
        ...
        .toList();
    final offboardings = ref
        .watch(staffOffboardingProvider)
        .where((o) => o.branchId == branchId)
        .toList();

    String? selectedResignerId = branchStaff.isNotEmpty
        ? branchStaff.first.id
        : null;
    final resignationDateCtrl = TextEditingController(
      text: DateTime.now().toString().substring(0, 10),
    );
    final lastWorkingDayCtrl = TextEditingController(
      text: DateTime.now()
  ...
  void _showExitInterviewDialog(
    BuildContext context,
    StaffOffboardingEntity offboarding,
  ) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(
          'Exit Interview Notes - ${_staffName(offboarding.staffId)}',
          style: const TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Enter remarks regarding work environment, reasons for leaving, and suggestions for improvement.',
              style: TextStyle(fontSize: 9, color: Colors.grey),
            ),
            const SizedBox(height: 8),
            TextField(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Exit interview notes saved!')),
              );
            },
            child: const Text(
              'Save Exit Interview',
  ...
  void _showAddCandidateDialog(BuildContext context, String branchId) {
    ...
    final depts = ref
        .read(academicDepartmentsProvider)
        .where((d) => d.branchId == branchId)
        .toList();
    if (depts.isNotEmpty) {
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: const [
                          ...
                          DropdownMenuItem(
                            value: 'HOD',
                            child: Text('HOD', style: TextStyle(fontSize: 9)),
                          ),
                          DropdownMenuItem(
                            value: 'branchAdmin',
                            child: Text('Admin', style: TextStyle(fontSize: 9)),
                          ),
                        ],
                        onChanged: (v) =>
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Candidate added to recruitment pipeline!'),
                  ),
                );
              },
              child: const Text(
  ...
  void _showOnboardingProgressDialog(
    BuildContext context,
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          backgroundColor: Colors.white,
          title: Text(
            'Onboarding Progress - ${candidate.name}',
            style: const TextStyle(
              fontSize: 13,
              fontWeight: FontWeight.bold,
              color: Colors.black87,
          ...
          content: Column(
            ...
            children: [
              Text(
                'Current Progress: ${(progress * 100).toStringAsFixed(0)}%',
                style: const TextStyle(fontSize: 10),
              ),
              Slider(
                value: progress,
              ...
              const Text(
                'Update the progress of induction, IT provisioning, workspace setup, and training.',
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ref
                    .read(recruitmentProvider.notifier)
                    .updateOnboardingProgress(candidate.id, progress);
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Onboarding progress updated!')),
                );
              },
              child: const Text(
                'Update',
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    style: const TextStyle(fontSize: 10),
                    decoration: const InputDecoration(
                      labelText: 'Workshop/Training Title',
                      isDense: true,
                    ),
                  ),
                  const SizedBox(height: 8),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                ref
                    .read(staffTrainingProvider.notifier)
                    .addTraining(
                      branchId: branchId,
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Training Workshop scheduled successfully!'),
                  ),
                );
              },
              child: const Text(
  ...
  void _showRequestTransferDialog(BuildContext context, String branchId) {
    ...
    final branchStaff = ref
        ...
        .toList();
    final branches = ref
        .read(organizationBranchesProvider)
        .where((b) => b.id != branchId)
        .toList();

    String? selectedStaffId = branchStaff.isNotEmpty
        ? branchStaff.first.id
        : null;
    String? selectedTargetBranchId = branches.isNotEmpty
        ? branches.first.id
        : null;
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              if (branchStaff.isEmpty)
                const Text(
                  'No active staff available in this branch.',
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Target Branch (Destination)',
                    isDense: true,
                  ),
                  style: const TextStyle(fontSize: 10, color: Colors.black87),
                  items: branches
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: (branchStaff.isEmpty || selectedTargetBranchId == null)
                  ? null
                  : () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'Inter-branch transfer request submitted successfully!',
                          ),
                        ),
                      );
                    },
  ...
  void _showExperienceCertificateDialog(
    BuildContext context,
    StaffEntity staff,
    dynamic branch,
  ) {
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'SYMBIOSYS GLOBAL SCHOOLS GROUP',
                          style: TextStyle(
                            fontSize: 8,
                            fontWeight: FontWeight.w600,
                            color: Colors.black54,
  ...
  void _showRelievingLetterDialog(
    BuildContext context,
    StaffEntity staff,
    dynamic branch,
  ) {
              ...
              children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      const TextSpan(
                        text: 'This relieving letter is formally issued to ',
                      ),
                      TextSpan(
                        text: staff.name,
                        style: const TextStyle(fontWeight: FontWeight.bold),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          _slipRow(
                            'Basic Salary',
                            '₹${p.basicSalary.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'Dearness Allowance (DA)',
                            '₹${p.da.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'House Rent Allowance (HRA)',
                            '₹${p.hra.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'Transport Allowance (TA)',
                            '₹${p.ta.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'Other Allowances',
                            '₹${p.allowances.toStringAsFixed(0)}',
                          ),
                        ],
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          _slipRow(
                            'Provident Fund (PF)',
                            '₹${p.pfDeduction.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'ESI Contribution',
                            '₹${p.esiDeduction.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'TDS (Income Tax)',
                            '₹${p.tdsDeduction.toStringAsFixed(0)}',
                          ),
                          _slipRow(
                            'Loan / Advance Deduct',
                            '₹${p.loanDeduction.toStringAsFixed(0)}',
                          ),
                        ],
                      ),
                    ),
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                    value: 'Absent',
                    child: Text('Absent', style: TextStyle(fontSize: 10)),
                  ),
                  DropdownMenuItem(
                    value: 'Late',
                    child: Text('Late Arrival', style: TextStyle(fontSize: 10)),
                  ),
                  DropdownMenuItem(
                    value: 'HalfDay',
                    child: Text('Half Day', style: TextStyle(fontSize: 10)),
                  ),
                ],
                onChanged: (v) {
                  if (v != null) {
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          backgroundColor: Colors.white,
          title: const Text(
            'Apply Staff Leave (CL, EL, ML, Casual, Medical)',
            style: TextStyle(
              fontSize: 13,
              fontWeight: FontWeight.bold,
              color: Colors.black87,
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          backgroundColor: Colors.white,
          title: const Text(
            'Assign Duty Roster & Shift Schedule',
            style: TextStyle(
              fontSize: 13,
              fontWeight: FontWeight.bold,
              color: Colors.black87,
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(
                    value: 'Morning',
                    child: Text(
                      'Morning Shift (08:00 AM - 02:30 PM)',
                      style: TextStyle(fontSize: 10),
                    ),
                  ),
                  DropdownMenuItem(
                    value: 'Evening',
                    child: Text(
                      'Evening Shift (02:30 PM - 08:30 PM)',
                      style: TextStyle(fontSize: 10),
                    ),
                  ),
                  DropdownMenuItem(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (selectedStaffId == null) return;
                ref
                    .read(dutyRosterProvider.notifier)
                    .assignDuty(
                      staffId: selectedStaffId!,
                      branchId: branchId,
                      date: dateCtrl.text,
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Duty Roster updated successfully!'),
                  ),
                );
              },
              child: const Text(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  style: const TextStyle(fontSize: 10),
                  decoration: const InputDecoration(
                    labelText: 'Pay Month (e.g. August 2026)',
                    isDense: true,
                  ),
                ),
                const SizedBox(height: 12),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Payroll processed & Net pay calculated!'),
                  ),
                );
              },
              child: const Text(
...
class _SubjectAssignmentForm extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_SubjectAssignmentForm> createState() =>
      _SubjectAssignmentFormState();
}

class _SubjectAssignmentFormState
    extends ConsumerState<_SubjectAssignmentForm> {
  String? _selClassId;
  ...
  Widget build(BuildContext context) {
    final classes = ref
        ...
        .toList();
    final sections = ref.watch(academicSectionsProvider);
    final classSections = _selClassId != null
        ? sections.where((s) => s.classId == _selClassId).toList()
        : <dynamic>[];
    final teachers = ref
        .watch(staffProvider)
        .where(
          (s) =>
              (s.branchId == widget.branchId ||
                  s.sharedBranchIds.contains(widget.branchId)) &&
            ...
            onPressed: () {
              ...
              ref
                  ...
                  .assignSubject(
                    ...
                    classId: _selClassId!,
                    sectionId: _selSectionId!,
                    subjectName: _subjectCtrl.text.trim(),
                    assignedTeacher: _selTeacher!,
                  );
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Subject assigned to teacher successfully!'),
                ),
              );
              _subjectCtrl.clear();
              setState(() {
...
class _SubstitutionFormState extends ConsumerState<_SubstitutionForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final teachers = widget.branchStaff
        .where((s) => s.role == 'Teacher' || s.role == 'HOD')
        .toList();

    bool isUnavailable(String staffId) {
      final isOnLeave = leaveList.any(
        (l) =>
            l.staffId == staffId &&
            l.status == 'Approved' &&
      ...
      final isAbsent = attendanceList.any(
        (a) =>
            a.staffId == staffId &&
            a.date == today &&
    ...
    final availableSubs = teachers
        .where((t) => t.id != _origTeacher && !isUnavailable(t.id))
        .toList();

    String? absentDeptId;
    if (_origTeacher != null) {
      final absentTeacher = teachers.firstWhere(
        (t) => t.id == _origTeacher,
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Auto-suggests available teachers from branch staff pool.',
          style: TextStyle(fontSize: 9, color: Colors.grey),
        ),
        const SizedBox(height: 8),
        Row(
          children: [
            ...
            Expanded(
              child: DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(
                  labelText: 'Substitute Teacher (Auto-Suggest)',
                  isDense: true,
                ),
                style: TextStyle(
                  fontSize: 10,
                ...
                items: availableSubs.map((t) {
                  final isSameDept =
                      absentDeptId != null && t.departmentId == absentDeptId;
                  final label = isSameDept
                      ? '${t.name} (Recommended - Same Dept)'
                      : t.name;
            ...
            onPressed: () {
              ...
              ref
                  ...
                  .createSubstitution(
                    ...
                    originalTeacherId: _origTeacher!,
                    substituteTeacherId: _subTeacher!,
                    classId: _classId ?? 'CLS-001',
                    sectionId: _sectionId ?? 'SEC-A-001',
                    reason: _reasonCtrl.text.trim(),
                  );
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Substitution created successfully!'),
                ),
              );
              _reasonCtrl.clear();
              setState(() {
