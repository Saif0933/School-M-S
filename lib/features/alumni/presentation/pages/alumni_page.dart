    ...
    return SingleChildScrollView(
      ...
      child: Row(
        ...
        children: [
                ...
                ...alumniList.map((al) => Card(
                      child: ListTile(
                        ...
                        trailing: ElevatedButton(
                          ...
                          child: const Text('View Association Card', style: TextStyle(fontSize: 9)),
                        ),
                      ),
                    )),
              ],
          ...
          // Printable Association Card Preview
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Member ID: ${_selectedAlumniCard!.id.replaceAll("AL-", "ALM-")}', style: const TextStyle(fontSize: 6, color: Colors.white30)),
