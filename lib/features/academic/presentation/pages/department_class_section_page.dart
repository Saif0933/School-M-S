...
class _DepartmentClassSectionPageState
  ...
  final _electiveSubjectsController =
      TextEditingController(); // Comma-separated list of elective subjects
  ...
  Widget _buildAcademicTreeTab(bool isDark) {
    ...
    final classes = ref
        ...
        .where((c) => c.branchId == _selectedBranchId)
        .toList();
          ...
          child: isWide
              ? Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 3,
                      child: _buildAcademicTreeActions(isDark, depts, classes),
                    ),
                  ],
                )
              : Column(
        ...
        child: Center(
          child: Column(
            children: [
              ...
              const Text(
                'Add departments on the right panel to begin.',
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ref
                            .read(academicDepartmentsProvider.notifier)
                                  ...
                                  children: [
                                    ...
                                    PopupMenuButton<String>(
                                      ...
                                      onSelected: (template) {
                                        ref
                                            .read(
                                              academicClassesProvider.notifier,
                                            )
                                            .updateClassTemplate(
                                              cls.id,
                                              template,
                                      ...
                                      itemBuilder: (context) => const [
                                        PopupMenuItem(
                                          value:
                                              'CBSE Standard 9-Point Template',
                                          child: Text(
                                            'CBSE Standard 9-Point',
                                            style: TextStyle(fontSize: 10),
                                          ),
                                        ),
                                        PopupMenuItem(
                                          value: 'ICSE Comprehensive Template',
                                          child: Text(
                                            'ICSE Comprehensive',
                                            style: TextStyle(fontSize: 10),
                                          ),
                                        ...
                                        PopupMenuItem(
                                          value: 'State Board Grade Template',
                                          child: Text(
                                            'State Board Grade',
                                            style: TextStyle(fontSize: 10),
                                          ),
                                        ...
                                        PopupMenuItem(
                                          value: 'IB PYP/MYP Criteria Template',
                                          child: Text(
                                            'IB Criteria Template',
                                            style: TextStyle(fontSize: 10),
                                          ),
                                        ),
                                      ],
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          tooltip: sec.isActive
                                              ? 'Deactivate Section'
                                              : 'Activate Section',
                                          onPressed: () {
                                            ref
                                                .read(
                                                  academicSectionsProvider
                                                      .notifier,
                                                )
                                                .toggleSectionStatus(sec.id);
                                          },
                                        ),
                                        const SizedBox(width: 4),
                                        IconButton(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Department Name (e.g. Primary)',
                  isDense: true,
                ),
              ),
              const SizedBox(height: 6),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_deptNameController.text.trim().isNotEmpty &&
                        _deptCodeController.text.trim().isNotEmpty) {
                      ref
                          .read(academicDepartmentsProvider.notifier)
                          .addDepartment(
                    ...
                    if (_classDeptId != null &&
                      ...
                      ref
                          ...
                          .addClass(
                            ...
                            maxStudentsCapacity:
                                int.tryParse(
                                  _classCapacityController.text.trim(),
                                ) ??
                                40,
                          );
                    ...
                    if (_secClassId != null &&
                      ...
                      ref
                          ...
                          .addSection(
                            ...
                            maxStudentsCapacity:
                                int.tryParse(
                                  _secCapacityController.text.trim(),
                                ) ??
                                40,
                          );
  ...
  Widget _buildSubjectAssignmentTab(bool isDark) {
    ...
    final assignments = ref
        ...
        .where((a) => a.branchId == _selectedBranchId)
        .toList();
          ...
          child: isWide
              ? Row(
                  ...
                  children: [
                    Expanded(
                      flex: 4,
                      child: _buildSubjectAssignmentsList(
                        isDark,
                        assignments,
                        classes,
                        sections,
                    ...
                    Expanded(
                      flex: 3,
                      child: _buildSubjectAssignmentForm(
                        isDark,
                        classes,
                        sections,
                      ),
  ...
  Widget _buildSubjectAssignmentForm(
    ...
    final filteredSections = sections
        .where((s) => s.classId == _subAssignClassId)
        .toList();
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: const InputDecoration(
              labelText: 'Select Section scope',
              isDense: true,
            ),
            style: TextStyle(
              fontSize: 11,
            ...
            items: [
              const DropdownMenuItem(
                value: 'ALL',
                child: Text('All Sections', style: TextStyle(fontSize: 11)),
              ),
  ...
  Widget _buildElectivesStreamsTab(bool isDark) {
    final streams = ref
        .watch(academicStreamsProvider)
        .where((s) => s.branchId == _selectedBranchId)
        .toList();
    final electives = ref
        .watch(academicElectivesProvider)
  ...
  Widget _buildBatchesTab(bool isDark) {
    final batches = ref
        .watch(academicBatchesProvider)
        .where((b) => b.branchId == _selectedBranchId)
        .toList();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        style: const TextStyle(fontSize: 11),
                        decoration: const InputDecoration(
                          labelText: 'Batch Name (e.g. Batch 2026 - 2027)',
                          isDense: true,
                        ),
                      ),
                      const SizedBox(height: 12),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (_batchNameController.text.trim().isNotEmpty) {
                              ref
                                  .read(academicBatchesProvider.notifier)
                                  .addBatch(
                                    _selectedBranchId!,
  ...
  Widget _buildStudentDirectoryTab(bool isDark) {
    ...
    final classSections = sections
        .where((s) => s.classId == _dirClassId)
        .toList();
    final filteredStudents = allStudents
        .where((s) => s.classId == _dirClassId && s.sectionId == _dirSectionId)
        .toList();
          ...
          if (_dirClassId == null || _dirSectionId == null)
            const Center(
              child: Padding(
                ...
                child: Text(
                  'Select Class and Section to view Student Directory.',
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Regenerate roll numbers alphabetically based on student names.',
                          style: TextStyle(fontSize: 10, color: Colors.grey),
                        ),
                      ],
                    ),
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'Alphabetical Roll Numbers successfully assigned!',
                          ),
                        ),
                      );
                    },
                                ...
                                children: [
                                  ...
                                  PopupMenuButton<String>(
                                    ...
                                    onSelected: (newSecId) {
                                      ref
                                          .read(
                                            academicStudentsProvider.notifier,
                                          )
                                          .transferSection(s.id, newSecId);
                                      ScaffoldMessenger.of(
                                        context,
                                      ).showSnackBar(
                                        const SnackBar(
                                          content: Text(
                                            'Student successfully transferred to new section!',
                                          ),
                                        ),
                                      );
                                    },
  ...
  Widget _buildPromotionTab(bool isDark) {
    ...
    final targetSections = sections
        .where((s) => s.classId == _promoToClassId)
        .toList();
    final eligibleStudents = students
        .where((s) => s.classId == _promoFromClassId)
        .toList();
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(
                labelText: 'Source Grade (From Class)',
                isDense: true,
              ),
              style: TextStyle(
                fontSize: 12,
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(
                labelText: 'Destination Grade (To Class)',
                isDense: true,
              ),
              style: TextStyle(
                fontSize: 12,
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(
                labelText: 'Default Allocation Section',
                isDense: true,
              ),
              style: TextStyle(
                fontSize: 12,
                  ...
                  if (_promoFromClassId != null &&
                    ...
                    if (eligibleStudents.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'No students found in the source class to promote!',
                          ),
                        ),
                      );
                      return;
  ...
  Widget _buildTimetableSlotsTab(bool isDark) {
    ...
    final filteredSections = sections
        .where((s) => s.classId == _ttClassId)
        .toList();
    final displayedSlots = slots
        .where(
          (s) =>
              s.classId == _ttClassId &&
              (s.sectionId == 'ALL' || s.sectionId == _ttSectionId),
        )
        .toList();
          ...
          child: isWide
              ? Row(
                  ...
                  children: [
                    Expanded(
                      flex: 4,
                      child: _buildTimetableSlotsList(
                        isDark,
                        displayedSlots,
                        classes,
                        sections,
            ...
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Filter Section scope',
                    isDense: true,
                  ),
                  style: TextStyle(
                    fontSize: 11,
          ...
          if (_ttClassId == null)
            const Center(
              child: Padding(
                padding: EdgeInsets.symmetric(vertical: 24),
                child: Text(
                  'Select a class to view timetable slots.',
                  style: TextStyle(fontSize: 12, color: Colors.grey),
                ),
              ),
            )
            ...
            const Center(
              child: Padding(
                padding: EdgeInsets.symmetric(vertical: 24),
                child: Text(
                  'No timetable slots configured for selection.',
                  style: TextStyle(fontSize: 11, color: Colors.grey),
                ),
              ),
            )
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Subject: ${s.subjectName} | Teacher: ${s.teacherName}',
                              style: const TextStyle(
                                fontSize: 9,
                                color: Colors.grey,
                              ),
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: const [
              DropdownMenuItem(
                value: 'Monday',
                child: Text('Monday', style: TextStyle(fontSize: 11)),
              ),
              DropdownMenuItem(
                value: 'Tuesday',
                child: Text('Tuesday', style: TextStyle(fontSize: 11)),
              ),
              DropdownMenuItem(
                value: 'Wednesday',
                child: Text('Wednesday', style: TextStyle(fontSize: 11)),
              ),
              DropdownMenuItem(
                value: 'Thursday',
                child: Text('Thursday', style: TextStyle(fontSize: 11)),
              ),
              DropdownMenuItem(
                value: 'Friday',
                child: Text('Friday', style: TextStyle(fontSize: 11)),
              ),
              DropdownMenuItem(
                value: 'Saturday',
                child: Text('Saturday', style: TextStyle(fontSize: 11)),
              ),
            ],
            onChanged: (val) {
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  style: const TextStyle(fontSize: 11),
                  decoration: const InputDecoration(
                    labelText: 'Start Time (e.g. 08:30 AM)',
                    isDense: true,
                  ),
                ),
              ),
              ...
              Expanded(
                child: TextField(
                  ...
                  style: const TextStyle(fontSize: 11),
                  decoration: const InputDecoration(
                    labelText: 'End Time (e.g. 09:15 AM)',
                    isDense: true,
                  ),
                ),
              ),
  ...
  Widget _buildClassFeePlansTab(bool isDark) {
    final classes = ref
        ...
        .toList();
    final feePlans = ref
        .watch(classFeePlansProvider)
        .where((f) => f.branchId == _selectedBranchId)
        .toList();
          ...
          child: isWide
              ? Row(
                  ...
                  children: [
                    Expanded(
                      flex: 4,
                      child: _buildClassFeePlansList(isDark, feePlans, classes),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      flex: 3,
                      child: _buildClassFeePlanForm(isDark, classes),
                    ),
                  ],
                )
              : Column(
  ...
  Widget _buildClassFeePlansList(
    bool isDark,
    List<ClassFeePlanEntity> feePlans,
    List<ClassEntity> classes,
  ) {
    return GlassCard(
      padding: const EdgeInsets.all(16),
        ...
        children: [
          ...
          if (feePlans.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text(
                  'No fee plans assigned to classes yet.',
                  style: TextStyle(fontSize: 11, color: Colors.grey),
                ),
              ),
            )
                  ...
                  child: Row(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Total Plan Amount: ₹${fp.totalAmount.toStringAsFixed(2)}',
                                style: const TextStyle(
                                  fontSize: 9,
                                  color: Colors.grey,
                                ),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ref
                              .read(classFeePlansProvider.notifier)
                              .removeFeePlan(fp.id);
                        },
                      ),
                    ],
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            style: const TextStyle(fontSize: 11),
            decoration: const InputDecoration(
              labelText: 'Fee Plan Label / Title',
              isDense: true,
            ),
          ),
          const SizedBox(height: 8),
          TextField(
            ...
            keyboardType: TextInputType.number,
            decoration: const InputDecoration(
              labelText: 'Total Academic Year Fee Amount',
              isDense: true,
            ),
          ),
          const SizedBox(height: 12),
  ...
  Widget _buildExamSchedulesTab(bool isDark) {
    final classes = ref
        ...
        .where((c) => c.branchId == _selectedBranchId)
        .toList();
    final examSchedules = ref
        .watch(examSchedulesProvider)
        .where((e) => e.branchId == _selectedBranchId)
        .toList();
          ...
          child: isWide
              ? Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 3,
                      child: _buildExamScheduleForm(isDark, classes),
                    ),
                  ],
                )
              : Column(
  ...
  Widget _buildExamSchedulesList(
    bool isDark,
                  ...
                  child: Row(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Subject: ${s.subjectName} | Date: ${s.examDate}',
                                style: const TextStyle(
                                  fontSize: 9,
                                  color: Colors.grey,
                                ),
                              ...
                              Text(
                                'Time Slot: ${s.startTime} - ${s.endTime}',
                                style: const TextStyle(
                                  fontSize: 8,
                                  color: Colors.grey,
                                ),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ref
                              .read(examSchedulesProvider.notifier)
                              .removeExam(s.id);
                        },
                      ),
                    ],
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            style: const TextStyle(fontSize: 11),
            decoration: const InputDecoration(
              labelText: 'Exam Name (e.g. Mid-Term Mock)',
              isDense: true,
            ),
          ),
          const SizedBox(height: 8),
  ...
  Widget _buildAttendanceRegisterTab(bool isDark) {
    ...
    final classSections = sections
        .where((s) => s.classId == _attClassId)
        .toList();
    final filteredStudents = students
        .where((s) => s.classId == _attClassId && s.sectionId == _attSectionId)
        .toList();
          ...
          if (_attClassId == null || _attSectionId == null)
            const Center(
              child: Padding(
                padding: EdgeInsets.all(40),
                child: Text(
                  'Select Class, Section and Date to open register.',
                  style: TextStyle(fontSize: 12, color: Colors.grey),
                ),
              ),
            )
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () {
                          ...
                          for (final s in filteredStudents) {
                            _tempAttendanceMap.putIfAbsent(
                              s.id,
                              () => 'Present',
                            );
                          }
                          ref
                              ...
                              .saveAttendance(
                                ...
                                studentStatusMap: Map<String, String>.from(
                                  _tempAttendanceMap,
                                ),
                              );
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                'Attendance Register successfully saved!',
                              ),
                            ),
                          );
                        },
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Roll No: ${s.rollNumber.isNotEmpty ? s.rollNumber : "-"}  |  Adm: ${s.admissionNumber}',
                                    style: const TextStyle(
                                      fontSize: 9,
                                      color: Colors.grey,
                                    ),
  ...
  Widget _buildParentTeacherMeetingsTab(bool isDark) {
    ...
    final sections = ref.watch(academicSectionsProvider);
    final meetings = ref
        .watch(parentTeacherMeetingsProvider)
        .where((m) => m.branchId == _selectedBranchId)
        .toList();

    final classSections = sections
        .where((s) => s.classId == _ptmClassId)
        .toList();
          ...
          child: isWide
              ? Row(
                  ...
                  children: [
                    Expanded(
                      flex: 4,
                      child: _buildPTMList(isDark, meetings, classes, sections),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      flex: 3,
                      child: _buildPTMForm(isDark, classes, classSections),
                    ),
                  ],
                )
              : Column(
                  ...
                  child: Row(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Grade: ${cls.name} (Section ${sec.name})',
                                style: const TextStyle(
                                  fontSize: 9,
                                  color: Colors.grey,
                                ),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ref
                              .read(parentTeacherMeetingsProvider.notifier)
                              .removeMeeting(m.id);
                        },
                      ),
                    ],
  ...
  Widget _buildPTMForm(
    bool isDark,
    List<ClassEntity> classes,
    List<SectionEntity> classSections,
  ) {
    return GlassCard(
      padding: const EdgeInsets.all(16),
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: const InputDecoration(
              labelText: 'Select Target Section',
              isDense: true,
            ),
            style: TextStyle(
              fontSize: 11,
          ...
          TextField(
            ...
            style: const TextStyle(fontSize: 11),
            decoration: const InputDecoration(
              labelText: 'Meeting Title (e.g. End of Term PTM)',
              isDense: true,
            ),
          ),
          const SizedBox(height: 8),
