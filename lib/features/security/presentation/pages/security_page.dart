            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text(v.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                  subtitle: Text('Meeting: ${v.whomToMeet} for ${v.purpose}\nPhone: ${v.phone} | Status: ${v.status}'),
                  trailing: Row(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                child: ListTile(
                  ...
                  title: Text(g.studentName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                  subtitle: Text('Guardian: ${g.parentName} | PIN: ${g.pickupCode}\nReason: ${g.reason} | Time: ${g.passTime}'),
                  trailing: Column(
                    ...
                    children: [
                      ...
                      if (g.status == 'Pending')
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(minimumSize: const Size(60, 20), padding: EdgeInsets.zero),
                        ...
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(backgroundColor: Colors.teal, minimumSize: const Size(60, 20), padding: EdgeInsets.zero),
